...
/*
 * Prompt 1: commit after every prompt
 *
...
// } else if (someNumber >= 20 && someNumber < 40) {
//   console.log("the number is mdiaum");
// } else if (someNumber > 40) {
...
//   for (let j = 0; j <= nestedArrays[i].length - 1; j++) {
